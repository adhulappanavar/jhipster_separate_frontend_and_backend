  ...
  return (
    <div>
      <h2 id="address-heading">
        <Translate contentKey="customerUiApp.address.home.title">Addresses</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="customerUiApp.address.home.createLabel">Create new Address</Translate>
        </Link>
      </h2>
        ...
        {addressList && addressList.length > 0 ? (
            ...
            <tbody>
              {addressList.map((address, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`customerUiApp.AddressType.${address.addressType}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="customerUiApp.address.home.notFound">No Addresses found</Translate>
            </div>
          )
        )}
      </div>
